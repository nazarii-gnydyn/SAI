    ...
    def runTest(self):
        ...
        try:
            for i in xrange(116, 128):
                ...
                print "ADDR : " + str(dest) + ". NET : " + str(net) +  ". MASK : " + str(mask)
...
class L3VlanNeighborMacUpdateTest(sai_base_test.ThriftInterfaceDataPlane):
    def runTest(self):
        ...
        #nhop1 = sai_thrift_create_nhop(self.client, addr_family, '10.10.10.2', rif_vlan_id)
